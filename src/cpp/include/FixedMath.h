...
class FixedMath {
 private:
  ...
  static inline const Fixed64 _atanApproximatedNumber1{
      static_cast<int64_t>(16036LL)};
  static inline const Fixed64 _atanApproximatedNumber2{
      static_cast<int64_t>(4345LL)};
 ...
 public:
  ...
  static Fixed64 Rcp(Fixed64 num) {
    return Fixed64::parseLong(4294967296LL / num.value);
  }
  ...
  static Fixed64 Repeat(Fixed64 value, Fixed64 length) {
    return Clamp(value - Floor(value / length) * length, Fixed64Const::Zero,
                 length);
  }
  ...
  static Fixed64 LerpAngle(Fixed64 from, Fixed64 to, Fixed64 t) {
    ...
    return Lerp(
        from,
        from + (num > Fixed64(FixLut::PI) ? num - Fixed64Const::Pi2 : num), t);
  }
