...
EMSCRIPTEN_BINDINGS(vector2_bindings) {
  value_object<Fixed64Wrapper>("Fixed64")
      .field("high", &Fixed64Wrapper::high)
      .field("low", &Fixed64Wrapper::low);

  value_object<Vector2Wrapper>("Vector2Wrapper")
      .field("x", &Vector2Wrapper::x)
      .field("y", &Vector2Wrapper::y);
...
EMSCRIPTEN_BINDINGS(vector3_module) {
  ...
  value_object<Vector3Wrapper>("Vector3Wrapper")
      .field("x", &Vector3Wrapper::x)
      .field("y", &Vector3Wrapper::y)
      .field("z", &Vector3Wrapper::z);
